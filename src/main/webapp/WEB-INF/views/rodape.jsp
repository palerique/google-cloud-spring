<footer id="layout-footer">
    <div class="clearfix container">
        ...
        <div id="social-footer"><!-- books-footer -->
            ...
            <ul class="footer-text-links">
                <li><a href="http://www.galandra.com.br" target="_blank">Galandra - Reforce seu ingl�s</a>
                </li>
                ...
                <li><a href="http://www.casadocodigo.com.br/pages/politica-de-privacidade" rel="nofollow">Pol�tica
                    de Privacidade</a></li>
            </ul>
        </div>
