    ...
    <article id="${produto.id }" itemscope>
                ...
                <ul id="variants" class="clearfix">
                    ...
                    <c:forEach items="${produto.precos }" var="preco">
                        <li class="buy-option" itemprop="offers" itemscope>
                            ...
                            <label itemprop="category" for="${preco.tipo }" itemscope
        ...
        <div class="container">
            ...
            <section class="data product-detail">
                ...
                <p><a rel="nofollow" href="https://groups.google.com/forum/#!forum/java8-casadocodigo">Participe
                    da lista de discuss&#227;o do livro</a></p>
